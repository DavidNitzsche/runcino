...
export type AlertKind = 'cron_fail' | 'regen_fail' | 'asc_stall' | 'crash' | 'briefing_failure' | 'webhook_failure' | 'apns_send_failed' | 'notifications_cron_error' | 'dedup_flag_census' | 'unknown';
