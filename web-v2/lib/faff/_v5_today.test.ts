  ...
  it('after_run · outdoor · asked-vs-ran, zones, and elevation all present', () => {
    const out = composeV5Today(baseCtx({
      ...
      recentRun: {
        ...
        elevationSamples: [0, 12, 8, 20], elevGainFt: 340, elevGainMeasured: true, routePolyline: null, routeSplits: [], routePhases: [], hrZones: [], paceBand: null,
  ...
  it('after_run · treadmill (5c) · onTheBelt present, elevation replaced entirely', () => {
    const out = composeV5Today(baseCtx({
      ...
      recentRun: {
        ...
        elevationSamples: [0, 4, 8], elevGainFt: 120, elevGainMeasured: true, routePolyline: null, routeSplits: [], routePhases: [], hrZones: [], paceBand: null,
  ...
  it('after_run · tone (Job 2 wire contract) · effort and hard-HR-cap breaches ink attention, pace never does', () => {
    const out = composeV5Today(baseCtx({
      ...
      recentRun: {
        ...
        elevationSamples: null, elevGainFt: null, elevGainMeasured: true, routePolyline: null, routeSplits: [], routePhases: [], hrZones: [], paceBand: null,
    ...
    it('drops Where you are on the after-run state too', () => {
      const out = composeV5Today(baseCtx({
        ...
        recentRun: {
          ...
          elevationSamples: [0, 6, 10], elevGainFt: 120, elevGainMeasured: true, routePolyline: null, routeSplits: [], routePhases: [], hrZones: [], paceBand: null,
