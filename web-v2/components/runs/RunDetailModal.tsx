...
// AFC fix 2 · synced to the one canonical zone ladder (= effort scale,
...
const ZONE_COLOR: Record<ZoneKey, string> = {
  z1: '#27B4E0', z2: '#14C08C', z3: '#F3AD38', z4: '#FF5722', z5: '#F43F5E',
};
