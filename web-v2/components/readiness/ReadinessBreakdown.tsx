 ...
 *
 * New: 5 vertical story rows, each one self-contained (subjective was
 * dropped, HR recovery added 2026-05-30 — see lib/coach/readiness.ts):
 *   - 3px accent strip on the LEFT colored by effect (red drag / green lift / grey neutral)
 *   - eyebrow with input name + weight share ("SLEEP · 28%")
