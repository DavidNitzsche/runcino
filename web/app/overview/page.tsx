...
const INTENSITY_CFG: Record<string, IntensityCfg> = {
  ...
  race:     { pos: 88, label: 'Race · Zone 4–5',   color: 'var(--orange)', copy: 'Race day. The training is done. Conservative first three miles, settle the middle, commit the last 5K.' },
};
...
export default async function OverviewPage() {
  ...
  // Race-readiness computation removed from /overview — it's now
  // surfaced on the /races page (at-a-glance) and inside
  // /races/[slug] (full Path-to-Goal). Today is for TODAY.
  ...
  return (
    <div className="overview-v4-page">
      ...
      <div className="page">
        ...
        {/* Race-status pill + tune-up nudge moved OFF /overview.
            Today is for TODAY. Race-readiness now lives on /races
            (at-a-glance row indicators) + inside /races/[slug] (full
            Path-to-Goal card + verdict). */}
