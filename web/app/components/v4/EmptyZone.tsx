    ...
    <div className="faff-empty-zone">
      ...
      <style jsx>{`
        .faff-empty-zone {
          ...
          border: 1.5px dashed rgba(8,8,8,.08);
          border-radius: 14px;
          text-align: center;
          display: flex;
        ...
        .faff-empty-zone-sub {
          ...
          color: rgba(8,8,8,.55); line-height: 1.55;
          max-width: 480px;
        }
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .faff-empty-btn:hover { background: rgba(8,8,8,.04); color: #080808; }
        ...
        .faff-empty-btn-primary:hover { background: rgba(8,8,8,.85); }
      `}</style>
    </>
  );
}
