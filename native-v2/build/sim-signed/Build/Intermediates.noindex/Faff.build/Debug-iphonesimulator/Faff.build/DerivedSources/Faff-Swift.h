...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Faff",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Faff15ColoredPolyline")
@interface ColoredPolyline : MKPolyline
...
SWIFT_CLASS("_TtC4Faff24NotificationsAppDelegate")
@interface NotificationsAppDelegate : NSObject <UIApplicationDelegate, UNUserNotificationCenterDelegate>
...
SWIFT_CLASS("_TtC4Faff13RouteEndpoint")
@interface RouteEndpoint : NSObject <MKAnnotation>
...
SWIFT_CLASS("_TtC4Faff17SignInCoordinator")
@interface SignInCoordinator : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASWebAuthenticationSession;
SWIFT_CLASS("_TtC4Faff18StravaOAuthSession")
@interface StravaOAuthSession : NSObject <ASWebAuthenticationPresentationContextProviding>
...
SWIFT_CLASS("_TtC4Faff9WatchSync")
@interface WatchSync : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@class WCSessionFile;
@class NSString;
@interface WatchSync (SWIFT_EXTENSION(Faff)) <WCSessionDelegate>
