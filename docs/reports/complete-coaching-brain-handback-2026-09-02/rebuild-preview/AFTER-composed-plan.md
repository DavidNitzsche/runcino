...
| 4 | 2026-09-21 | 56.2 | 18.0 | LONG | 2 | 1 | — |
| 5 | 2026-09-28 | 41.0 | 14.0 | LONG | 2 | 2 | cutback |
| 6 | 2026-10-05 | 58.0 | 18.0 | LONG | 2 | 1 | — |
| 7 | 2026-10-12 | 58.5 | 19.5 | LONG · 5mi @ M + 2mi @ T | 1 | 1 | — |
| 8 | 2026-10-19 | 45.0 | 16.0 | LONG | 2 | 2 | cutback |
| 9 | 2026-10-26 | 58.5 | 20.5 | LONG | 2 | 1 | — |
| 10 | 2026-11-02 | 45.6 | 13.1 | RACE | 2 | 1 | cutback |
| 11 | 2026-11-09 | 39.5 | 17.0 | LONG | 0 | 2 | cutback |
| 12 | 2026-11-16 | 46.0 | 19.0 | LONG | 1 | 1 | — |
| 13 | 2026-11-23 | 33.5 | 13.5 | LONG | 1 | 1 | — |
...
- `[{"weekStartISO":"2026-11-16","phase":"TAPER","context":"taper","pace":"M","scope":"single-workout","doseMi":11,"weeklyMi":46,"capMi":9.2,"overByMi":1.8,"sharePct":23.91,"basis":"percentage","enforced":false,"message":"Session doses 11 mi at M on 46 mi/wk (23.91%) · doctrine caps it at 9.2 mi (20% of weekly mi)"},{"weekStartISO":"2026-11-23","phase":"TAPER","context":"taper","pace":"M","scope":"single-workout","doseMi":7,"weeklyMi":33.5,"capMi":6.7,"overByMi":0.3,"sharePct":20.9,"basis":"percentage","enforced":false,"message":"Session doses 7 mi at M on 33.5 mi/wk (20.9%) · doctrine caps it at 6.7 mi (20% of weekly mi)"}]`

## Refusals, fallbacks and uncertainty

- `placement_compromises` = `[{"code":"ACCEPT_AS_HARD_WORKOUT","raceSlug":"dodgers","raceName":"Dodgers","raceDateISO":"2026-09-26","dateISO":"2026-09-27","detail":"18mi long run stands 1 day(s) after Dodgers (6.21mi, C effort) · 24.21mi across the pair","citation":"Research/00b-recovery-protocols.md §\"Recovery by Effort\" (C race · treat like a hard workout) · Research/22-plan-templates.md §\"Multi-Race Year Planning\""}]`
- `goal_realism` = `{"flag":false,"assessable":true,"basis":"measured_vdot","estimatedCurrentVdot":47.8}`
...
- `recent_avg_mpw` = `34.2`
- `weeklyAvg4w` = `34.2`
- `tier_peak_weekly_band` = `[65,90]`
- `tier_peak_long_band` = `[22,24]`
- not recorded by this run: `travel_shaped`, `block_anchor`

Full authored_state keys: `block_strategy`, `capacity_tier`, `citations`, `course`, `derived_from`, `easy_day_median_mi`, `easy_pace_s_per_mi`, `embedded_races`, `goal_pace_s_per_mi`, `goal_realism`, `goal_tier`, `horizon_raise`, `is_mid_block`, `load_tier_reduced_by_goal`, `lthr_bpm`, `pace_blend`, `phase_answers`, `placement_compromises`, `prescribed_race_pace`, `quality_days_planned`, `race_distance_mi`, `ramp_base`, `recent_avg_mpw`, `t_pace_s_per_mi`, `thesis_at_authoring`, `tier_peak_long_band`, `tier_peak_weekly_band`, `total_weeks`, `weeklyAvg4w`
...
| 2026-09-23 | easy | MEDIUM-LONG | 9.5 | — | — | — | — | — |
| 2026-09-24 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-09-25 | easy | EASY · 6×20s strides | 7.0 | — | — | — | — | — |
| 2026-09-26 | race | RACE | 6.2 | — | — | — | — | — |
| 2026-09-27 | long | LONG | 18.0 | — | — | — | — | — |

### Week 5 · 2026-09-28 · 41.0 mi · cutback

| Date | Type | Session | Mi | Pace | WU | CD | HR cap | Abort rules |
|---|---|---|---|---|---|---|---|---|
| 2026-09-28 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-09-29 | threshold | 6×1km @ ST pace · 60s jog | 9.0 | — | — | — | — | — |
| 2026-09-30 | easy | EASY · 6×20s strides | 5.0 | — | — | — | — | — |
| 2026-10-01 | intervals | 6×800m @ I pace · 2 min jog | 8.0 | — | — | — | — | — |
| 2026-10-02 | easy | EASY · 6×20s strides | 5.0 | — | — | — | — | — |
| 2026-10-03 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-10-04 | long | LONG | 14.0 | — | — | — | — | — |

### Week 6 · 2026-10-05 · 58.0 mi 

| Date | Type | Session | Mi | Pace | WU | CD | HR cap | Abort rules |
|---|---|---|---|---|---|---|---|---|
| 2026-10-05 | easy | EASY · 6×20s strides | 6.5 | — | — | — | — | — |
| 2026-10-06 | tempo | 4mi continuous mile cutdowns | 8.0 | — | — | — | — | — |
| 2026-10-07 | easy | MEDIUM-LONG · 2mi @ T | 11.5 | — | — | — | — | — |
...
| 2026-10-11 | long | LONG | 18.0 | — | — | — | — | — |

### Week 7 · 2026-10-12 · 58.5 mi 

| Date | Type | Session | Mi | Pace | WU | CD | HR cap | Abort rules |
|---|---|---|---|---|---|---|---|---|
| 2026-10-12 | easy | EASY · 6×20s strides | 6.5 | — | — | — | — | — |
| 2026-10-13 | easy | EASY · 6×20s strides | 7.5 | — | — | — | — | — |
...
| 2026-10-18 | long | LONG · 5mi @ M + 2mi @ T | 19.5 | — | — | — | — | — |
...
| 2026-10-21 | easy | EASY · 8×20s strides | 6.5 | — | — | — | — | — |
| 2026-10-22 | intervals | 8×3 min @ I pace · 90s jog | 8.0 | — | — | — | — | — |
| 2026-10-23 | easy | EASY · 8×20s strides | 6.0 | — | — | — | — | — |
| 2026-10-24 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-10-25 | long | LONG | 16.0 | — | — | — | — | — |

### Week 9 · 2026-10-26 · 58.5 mi 

| Date | Type | Session | Mi | Pace | WU | CD | HR cap | Abort rules |
|---|---|---|---|---|---|---|---|---|
| 2026-10-26 | easy | EASY · 8×20s strides | 6.0 | — | — | — | — | — |
| 2026-10-27 | tempo | 5.5mi continuous wave tempo | 9.5 | — | — | — | — | — |
| 2026-10-28 | easy | EASY · 8×20s strides | 7.5 | — | — | — | — | — |
| 2026-10-29 | intervals | 8×3 min @ I pace · 90s jog | 8.0 | — | — | — | — | — |
| 2026-10-30 | easy | EASY | 7.0 | — | — | — | — | — |
| 2026-10-31 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-11-01 | long | LONG | 20.5 | — | — | — | — | — |

### Week 10 · 2026-11-02 · 45.6 mi · cutback

| Date | Type | Session | Mi | Pace | WU | CD | HR cap | Abort rules |
|---|---|---|---|---|---|---|---|---|
| 2026-11-02 | easy | EASY · 8×20s strides | 6.0 | — | — | — | — | — |
| 2026-11-03 | threshold | 3×1mi @ T pace · 60s jog | 8.5 | — | — | — | — | — |
| 2026-11-04 | easy | MEDIUM-LONG | 9.5 | — | — | — | — | — |
| 2026-11-05 | easy | EASY · 8×20s strides | 6.5 | — | — | — | — | — |
| 2026-11-06 | shakeout | SHAKEOUT · 4×20s strides | 2.0 | — | — | — | — | — |
| 2026-11-07 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-11-08 | race | RACE | 13.1 | — | — | — | — | — |

### Week 11 · 2026-11-09 · 39.5 mi · cutback

| Date | Type | Session | Mi | Pace | WU | CD | HR cap | Abort rules |
|---|---|---|---|---|---|---|---|---|
| 2026-11-09 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-11-10 | easy | EASY | 5.0 | — | — | — | — | — |
| 2026-11-11 | easy | EASY · 8×20s strides | 6.5 | — | — | — | — | — |
| 2026-11-12 | easy | EASY | 5.0 | — | — | — | — | — |
| 2026-11-13 | easy | EASY · 8×20s strides | 6.0 | — | — | — | — | — |
| 2026-11-14 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-11-15 | long | LONG | 17.0 | — | — | — | — | — |

### Week 12 · 2026-11-16 · 46.0 mi 

| Date | Type | Session | Mi | Pace | WU | CD | HR cap | Abort rules |
|---|---|---|---|---|---|---|---|---|
| 2026-11-16 | easy | EASY · 6×20s strides | 3.0 | — | — | — | — | — |
| 2026-11-17 | tempo | 2.5 mi WU · 11 mi @ MP · 1.5 mi CD | 15.0 | — | — | — | — | — |
| 2026-11-18 | easy | EASY · 6×20s strides | 3.0 | — | — | — | — | — |
| 2026-11-19 | easy | EASY | 3.0 | — | — | — | — | — |
| 2026-11-20 | easy | EASY | 3.0 | — | — | — | — | — |
| 2026-11-21 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-11-22 | long | LONG | 19.0 | — | — | — | — | — |

### Week 13 · 2026-11-23 · 33.5 mi 

| Date | Type | Session | Mi | Pace | WU | CD | HR cap | Abort rules |
|---|---|---|---|---|---|---|---|---|
| 2026-11-23 | easy | EASY · 6×20s strides | 2.5 | — | — | — | — | — |
| 2026-11-24 | tempo | 2 mi WU · 7 mi @ MP · 1 mi CD | 10.0 | — | — | — | — | — |
| 2026-11-25 | easy | EASY · 6×20s strides | 2.5 | — | — | — | — | — |
| 2026-11-26 | easy | EASY | 2.5 | — | — | — | — | — |
| 2026-11-27 | easy | EASY | 2.5 | — | — | — | — | — |
| 2026-11-28 | rest | REST | 0.0 | — | — | — | — | — |
| 2026-11-29 | long | LONG | 13.5 | — | — | — | — | — |
