...
|---|---|---|
| `user_uuid = 0645f40c-951d-4ccc-b86e-9979cd26c795` | **CONFIRMED-BY-ME** | `[PROD-QUERY]` `select id from users where email='dnitch85@me.com'` → exact match |
