...
**Identity:** `users.id = '0645f40c-951d-4ccc-b86e-9979cd26c795'`, `email = 'dnitch85@me.com'` — confirmed the schema really does use `id` (not `user_uuid`) on `users`, corroborating the report's naming-asymmetry observation. [PROD-QUERY]
