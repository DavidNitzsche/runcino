...
**Companion to** `docs/watch-face-design-handoff.md` (the watch agent's handoff,
...
- A visual contact sheet at `docs/watch-faces-2026-05-26.html`
...
```
docs/
├── watch-face-design-handoff.md          ⭐ visual primitives + face catalog
├── watch-faces-2026-05-26.html           ⭐ contact sheet (open in browser)
├── watch-takeovers-v2.html                takeover concepts
├── WATCH_COMPLETION_PAYLOAD.md           ⭐ wire contract
├── WATCH_DESIGN_BRIEF.md                 (this file)
└── coach/WATCH_CONTRACT.md               legacy contract — superseded by §2 here
```
